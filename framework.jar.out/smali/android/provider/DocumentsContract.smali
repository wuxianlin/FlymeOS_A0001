...
.field public static final EXTRA_CHILD:Ljava/lang/String; = "child"
...
.field public static final METHOD_ISCHILD_DOCUMENT:Ljava/lang/String; = "android:isChildDocument"
...
.method public static getPathDocument(Landroid/content/ContentProviderClient;Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 1073
    const-string v2, "android:getPathDocument"
...
.method public static isChildDocument(Landroid/content/ContentProviderClient;Landroid/net/Uri;Ljava/lang/String;)Z
    .locals 4
    .param p0, "client"    # Landroid/content/ContentProviderClient;
    .param p1, "parentDocumentUri"    # Landroid/net/Uri;
    ...
    .line 1043
    const-string v2, "android:isChildDocument"
...
.method public static isChildDocument(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;)Z
    .locals 4
    .param p0, "resolver"    # Landroid/content/ContentResolver;
    .param p1, "documentUri"    # Landroid/net/Uri;
    .param p2, "displayName"    # Ljava/lang/String;
    ...
    .local v0, "client":Landroid/content/ContentProviderClient;
    :try_start_0
    invoke-static {v0, p1, p2}, Landroid/provider/DocumentsContract;->isChildDocument(Landroid/content/ContentProviderClient;Landroid/net/Uri;Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v3, "Failed to test if document is child"
