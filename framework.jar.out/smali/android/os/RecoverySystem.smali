...
.method public static installOppoRepackPackage(Landroid/content/Context;Ljava/util/ArrayList;)V
    .locals 12
    .param p0, "context"    # Landroid/content/Context;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    const-string v10, "installOppoRepackPackage failed before reboot, packageFileList is null!!!"
    ...
    .line 537
    .local v8, "strWipeData":Ljava/lang/String;
    const/4 v1, 0x0

    .line 539
    .local v1, "bWipeData":Z
    const-string v7, "/data/media/0/"

    .line 542
    .local v7, "recoveryPath":Ljava/lang/String;
    :try_start_0
    ...
    const-string v11, "!!! REBOOT TO INSTALL new"
    ...
    const-string v10, "!!! WIPE DATA FOR OTA !!!"
    ...
    invoke-virtual {v6, v9}, Landroid/os/PowerManager;->reboot(Ljava/lang/String;)V
