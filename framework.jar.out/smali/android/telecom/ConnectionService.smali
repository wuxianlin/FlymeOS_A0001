...
.method private addParticipantWithConference(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 874
    const-string v1, "addParticipantWithConference"
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    .line 677
    .local v19, "address":Landroid/net/Uri;
    if-nez v19, :cond_5
    ...
    invoke-static/range {v21 .. v21}, Landroid/telecom/Connection;->toLogSafePhoneNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/telecom/Connection;->getCallCapabilities()I
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/telecom/Connection;->getCallSubstate()I

    move-result v18

    invoke-direct/range {v3 .. v18}, Landroid/telecom/ParcelableConnection;-><init>(Landroid/telecom/PhoneAccountHandle;IILandroid/net/Uri;ILjava/lang/String;ILcom/android/internal/telecom/IVideoProvider;IZZLandroid/telecom/StatusHints;Landroid/telecom/DisconnectCause;Ljava/util/List;I)V
    ...
    .line 663
    .end local v19    # "address":Landroid/net/Uri;
    ...
    .line 677
    .restart local v19    # "address":Landroid/net/Uri;
...
.method public final addConference(Landroid/telecom/Conference;)V
    ...
    check-cast v7, Landroid/telecom/Connection;

    .line 996
    .local v7, "connection":Landroid/telecom/Connection;
    ...
    .line 1000
    .end local v7    # "connection":Landroid/telecom/Connection;
    :cond_1
    ...
    invoke-virtual {v1, v10, v0}, Landroid/telecom/ConnectionServiceAdapter;->addConferenceCall(Ljava/lang/String;Landroid/telecom/ParcelableConference;)V
    ...
    invoke-virtual {v1, v10, v2}, Landroid/telecom/ConnectionServiceAdapter;->setVideoProvider(Ljava/lang/String;Landroid/telecom/Connection$VideoProvider;)V
    ...
    invoke-virtual {v1, v10, v2}, Landroid/telecom/ConnectionServiceAdapter;->setVideoState(Ljava/lang/String;I)V
    ...
    .line 1015
    .restart local v7    # "connection":Landroid/telecom/Connection;
    iget-object v1, p0, Landroid/telecom/ConnectionService;->mIdByConnection:Ljava/util/Map;
    ...
    invoke-virtual {v1, v8, v10}, Landroid/telecom/ConnectionServiceAdapter;->setIsConferenced(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1021
    .end local v4    # "connectionIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
