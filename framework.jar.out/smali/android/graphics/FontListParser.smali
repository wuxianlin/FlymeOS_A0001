...
.method private static isLegacyFormat(Ljava/io/File;)Z
    .locals 7
    ...
    invoke-interface {v2, v4, v5, v6}, Lorg/xmlpull/v1/XmlPullParser;->require(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static parse(Ljava/io/File;Ljava/io/File;)Landroid/graphics/FontListParser$Config;
    .locals 2
    .param p0, "configFilename"    # Ljava/io/File;
    ...
    .line 82
    .local v0, "in":Ljava/io/FileInputStream;
    invoke-static {p0}, Landroid/graphics/FontListParser;->isLegacyFormat(Ljava/io/File;)Z
    ...
    invoke-static {v0, v1}, Landroid/graphics/FontListParser;->parseLegacyFormat(Ljava/io/InputStream;Ljava/lang/String;)Landroid/graphics/FontListParser$Config;
    ...
    invoke-static {v0, v1}, Landroid/graphics/FontListParser;->parseNormalFormat(Ljava/io/InputStream;Ljava/lang/String;)Landroid/graphics/FontListParser$Config;
