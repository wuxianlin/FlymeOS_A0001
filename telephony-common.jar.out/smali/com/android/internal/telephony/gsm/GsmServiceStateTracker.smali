...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLteCellLocList:Ljava/util/ArrayList;
    ...
    .line 209
    iput-boolean v5, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->bCheckNoServiceAgain:Z

    .line 216
    iput-boolean v4, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isRemoveCard:Z
    ...
    .line 337
    iput-object v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->plmn_mcc_mnc:[Ljava/lang/String;

    .line 338
    iput-object v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->plmn_oppo_name:Landroid/content/res/TypedArray;
...
.method private isCardPresent()Z
    ...
    .line 2558
    .local v0, "mCard":Lcom/android/internal/telephony/uicc/UiccCard;
...
.method private pollStateDone()V
    ...
    sget-wide v42, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->lastTime:J

    const-wide/16 v44, 0x59d8

    add-long v42, v42, v44

    cmp-long v42, v12, v42
    ...
    .line 1313
    .restart local v27    # "isDelayOk":Z
    :cond_13
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v42

    sput-wide v42, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->lastTime:J

    .line 1315
    const-string v42, "GsmSST"

    const-string v43, "oppo: send OPPOEVENT_CHECK_NO_SERVICE event"

    invoke-static/range {v42 .. v43}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->bCheckNoServiceAgain:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    sput-wide v20, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->lastTime:J
...
.method protected onUpdateIccAvailability()V
    ...
    sput-wide v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->lastTime:J
...
.method public powerOffRadioSafely(Lcom/android/internal/telephony/dataconnection/DcTrackerBase;)V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isCardPresent()Z
...
.method protected updateSpnDisplay()V
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    invoke-virtual {v2, v13}, Lcom/android/internal/telephony/uicc/IccRecords;->getDisplayRule(Ljava/lang/String;)I
    ...
    invoke-static {v13, v5, v11}, Lcom/android/internal/telephony/gsm/OppoGsmServiceStateTracker;->oppoGetAustraliaPlmn(Landroid/telephony/ServiceState;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 825
    .local v10, "showSpnTemp":Z
    const/4 v8, 0x0

    .line 826
    .local v8, "showPlmnTemp":Z
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mSS:Landroid/telephony/ServiceState;

    invoke-static {v13, v5, v12}, Lcom/android/internal/telephony/gsm/OppoGsmServiceStateTracker;->oppoShowSpnOrPlmn(Landroid/telephony/ServiceState;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 839
    .local v4, "mSIMRecords":Lcom/android/internal/telephony/uicc/SIMRecords;
    if-eqz v4, :cond_4
    ...
    const-string v14, "spnDisplayCondition = "

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v13

    invoke-virtual {v4}, Lcom/android/internal/telephony/uicc/SIMRecords;->getSpnDisplayCondition()I
    ...
    .line 862
    .end local v4    # "mSIMRecords":Lcom/android/internal/telephony/uicc/SIMRecords;
    :cond_4
    :goto_5
    const/4 v13, 0x1
    ...
    .line 878
    :cond_6
    const-string v13, "[Oppo] Ignore null plmn"
    ...
    .line 905
    .end local v8    # "showPlmnTemp":Z
    .end local v10    # "showSpnTemp":Z
    :cond_7
    :goto_6
    move-object/from16 v0, p0

    iput-boolean v9, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurShowSpn:Z

    .line 906
    move-object/from16 v0, p0

    iput-boolean v7, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurShowPlmn:Z

    .line 907
    move-object/from16 v0, p0

    iput-object v12, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mCurSpn:Ljava/lang/String;
    ...
    .line 848
    .restart local v4    # "mSIMRecords":Lcom/android/internal/telephony/uicc/SIMRecords;
    .restart local v8    # "showPlmnTemp":Z
    .restart local v9    # "showSpn":Z
    .restart local v10    # "showSpnTemp":Z
    :cond_f
    move-object/from16 v0, p0
    ...
    .line 857
    :cond_11
    const-string v13, "do not satisfy the requirement of Mexico"
    ...
    .line 884
    :cond_13
    const-string v13, "[Oppo] can\'t show spn"
    ...
    invoke-virtual {v3, v13, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v3, v13}, Landroid/telephony/SubscriptionManager;->putPhoneIdAndSubIdExtra(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v13, v3, v14}, Landroid/content/Context;->sendStickyBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
