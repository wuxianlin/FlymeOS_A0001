...
.field private static final EVENT_OPPO_END_CDMA_CALL:I = 0x64
...
.field private static final TIME_END_CDMA_CALL_DELAY:I = 0x3a98
...
.field mWaitingConnection:Lcom/android/internal/telephony/cdma/CdmaConnection;
...
.method constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 107
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsSwitch:Z

    .line 108
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsAccept:Z

    .line 109
    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mWaitingConnection:Lcom/android/internal/telephony/cdma/CdmaConnection;
...
.method private dialThreeWay(Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaConnection;->fakeHoldCall()V
    ...
    .line 306
    .restart local v0    # "fgConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    :cond_0
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mCi:Lcom/android/internal/telephony/CommandsInterface;
...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mWaitingConnection:Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->sendEmptyMessageDelayed(IJ)Z
...
.method private switchCall()V
    ...
    .line 1367
    .local v0, "bgConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    if-eqz v1, :cond_0

    .line 1368
    invoke-virtual {v1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->fakeHoldCall()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v7, "Event EVENT_POLL_CALLS_RESULT Received"
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLastRelevantPoll:Landroid/os/Message;

    if-ne p1, v6, :cond_0

    .line 1104
    iput-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mNeedsPoll:Z

    .line 1105
    iput-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLastRelevantPoll:Landroid/os/Message;
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string v8, "EVENT_SWITCH_RESULT mIsSwitch="

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-boolean v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsSwitch:Z
    ...
    .line 1119
    iput-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsAccept:Z

    .line 1120
    iget-boolean v6, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsSwitch:Z

    if-eqz v6, :cond_2

    .line 1121
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->switchCall()V

    .line 1122
    iput-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsSwitch:Z
    ...
    .local v4, "i":I
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mDroppedDuringPoll:Ljava/util/ArrayList;
    ...
    .line 1178
    :sswitch_7
    iget-boolean v6, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingCallInEcm:Z
    ...
    iget v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingCallClirMode:I

    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->obtainCompleteMessage()Landroid/os/Message;

    move-result-object v9

    invoke-interface {v6, v7, v8, v9}, Lcom/android/internal/telephony/CommandsInterface;->dial(Ljava/lang/String;ILandroid/os/Message;)V

    .line 1180
    iput-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingCallInEcm:Z

    .line 1182
    :cond_5
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPhone:Lcom/android/internal/telephony/cdma/CDMAPhone;

    invoke-virtual {v6, p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->unsetOnEcbModeExitResponse(Landroid/os/Handler;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V

    .line 1189
    const-string v6, "CdmaCallTracker"

    const-string v7, "Event EVENT_CALL_WAITING_INFO_CDMA Received"
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onConnectedInOrOut()V
    ...
    .line 1205
    new-instance v6, Lcom/android/internal/telephony/cdma/CdmaCallTracker$1;

    invoke-direct {v6, p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker$1;-><init>(Lcom/android/internal/telephony/cdma/CdmaCallTracker;)V

    iget v7, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->m3WayCallFlashDelay:I

    int-to-long v8, v7

    invoke-virtual {p0, v6, v8, v9}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    const-string v7, "exception happened on Blank Flash for 3-way call"
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mWaitingConnection:Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    const-string v8, "EVENT_OPPO_END_CDMA_CALL cwConn:"
    ...
    const-string v8, " mWaitingConnection:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mWaitingConnection:Lcom/android/internal/telephony/cdma/CdmaConnection;
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string v28, "CdmaCallTracker"
    ...
    new-instance v29, Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-virtual/range {v28 .. v29}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    const-string v29, "adding fgCall cn "
    ...
    const-string v29, " to droppedDuringPoll"
    ...
    const-string v29, "adding rgCall cn "
    ...
    invoke-virtual/range {v28 .. v29}, Lcom/android/internal/telephony/cdma/CdmaCall;->setGeneric(Z)V
    ...
    const-string v30, "Error in RIL, Phantom call appeared "
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/internal/telephony/cdma/CDMAPhone;->is_test_card()Z
    ...
    .line 801
    check-cast v28, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyPreciseCallStateChanged()V
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaCall;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/internal/telephony/cdma/CdmaCall;->colorosSetCause(I)V
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaConnection;)V
    ...
    .line 840
    iget-object v2, p1, Lcom/android/internal/telephony/cdma/CdmaConnection;->mOwner:Lcom/android/internal/telephony/cdma/CdmaCallTracker;
    ...
    const-string v4, "does not belong to CdmaCallTracker "
    ...
    .line 852
    iput-boolean v5, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mHangupPendingMO:Z

    .line 854
    iget v2, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingOperations:I
    ...
    iget v3, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingOperations:I
    ...
    .line 856
    iput v4, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingOperations:I
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLastRelevantPoll:Landroid/os/Message;
    ...
    const-string v4, "CdmaCallTracker WARN: hangup() on absent connection "
...
.method switchWaitingOrHoldingAndActive()V
    ...
    .line 373
    :cond_1
    iget-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsAccept:Z
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mIsSwitch:Z
