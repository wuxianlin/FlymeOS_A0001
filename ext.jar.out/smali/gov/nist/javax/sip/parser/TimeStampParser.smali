...
.method public parse()Lgov/nist/javax/sip/header/SIPHeader;
    ...
    .line 67
    sget-boolean v5, Lgov/nist/javax/sip/parser/TimeStampParser;->debug:Z

    if-eqz v5, :cond_0

    .line 68
    const-string v5, "TimeStampParser.parse"

    invoke-virtual {p0, v5}, Lgov/nist/javax/sip/parser/TimeStampParser;->dbg_enter(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, v5}, Lgov/nist/javax/sip/parser/TimeStampParser;->headerName(I)V

    .line 73
    const-string v5, "Timestamp"

    invoke-virtual {v4, v5}, Lgov/nist/javax/sip/header/TimeStamp;->setHeaderName(Ljava/lang/String;)V

    .line 75
    iget-object v5, p0, Lgov/nist/javax/sip/parser/TimeStampParser;->lexer:Lgov/nist/core/LexerCore;
    ...
    invoke-virtual {v5, v8}, Lgov/nist/core/LexerCore;->lookAhead(I)C
    ...
    .line 86
    .local v6, "ts":F
    invoke-virtual {v4, v6}, Lgov/nist/javax/sip/header/TimeStamp;->setTimeStamp(F)V
    :try_end_1
    ...
    invoke-virtual {v4, v6}, Lgov/nist/javax/sip/header/TimeStamp;->setDelay(F)V
    :try_end_3
    ...
    invoke-virtual {p0, v5}, Lgov/nist/javax/sip/parser/TimeStampParser;->dbg_leave(Ljava/lang/String;)V
    ...
    .line 89
    .local v6, "ts":J
    invoke-virtual {v4, v6, v7}, Lgov/nist/javax/sip/header/TimeStamp;->setTime(J)V
    :try_end_4
    ...
    invoke-virtual {p0, v5}, Lgov/nist/javax/sip/parser/TimeStampParser;->createParseException(Ljava/lang/String;)Ljava/text/ParseException;
