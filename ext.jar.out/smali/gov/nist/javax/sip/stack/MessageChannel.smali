...
.method public sendMessage(Lgov/nist/javax/sip/message/SIPMessage;Ljavax/sip/address/Hop;)V
    ...
    .line 205
    .local v4, "hopAddr":Ljava/net/InetAddress;
    :try_start_0
    ...
    .line 206
    .local v14, "messageProcessor":Lgov/nist/javax/sip/stack/MessageProcessor;
    invoke-virtual {v14}, Lgov/nist/javax/sip/stack/MessageProcessor;->getIpAddress()Ljava/net/InetAddress;
    ...
    invoke-virtual {v14}, Lgov/nist/javax/sip/stack/MessageProcessor;->getPort()I
    ...
    invoke-virtual {v14}, Lgov/nist/javax/sip/stack/MessageProcessor;->getTransport()Ljava/lang/String;
    ...
    invoke-virtual {v14, v4, v2}, Lgov/nist/javax/sip/stack/MessageProcessor;->createMessageChannel(Ljava/net/InetAddress;I)Lgov/nist/javax/sip/stack/MessageChannel;

    move-result-object v13

    .line 211
    .local v13, "messageChannel":Lgov/nist/javax/sip/stack/MessageChannel;
    instance-of v2, v13, Lgov/nist/javax/sip/stack/RawMessageChannel;

    if-eqz v2, :cond_2

    .line 212
    check-cast v13, Lgov/nist/javax/sip/stack/RawMessageChannel;

    .end local v13    # "messageChannel":Lgov/nist/javax/sip/stack/MessageChannel;
    move-object/from16 v0, p1

    invoke-interface {v13, v0}, Lgov/nist/javax/sip/stack/RawMessageChannel;->processMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lgov/nist/javax/sip/stack/MessageChannel;->logMessage(Lgov/nist/javax/sip/message/SIPMessage;Ljava/net/InetAddress;IJ)V

    .line 237
    .end local v14    # "messageProcessor":Lgov/nist/javax/sip/stack/MessageProcessor;
    :cond_1
    :goto_1
    return-void

    .line 205
    .restart local v14    # "messageProcessor":Lgov/nist/javax/sip/stack/MessageProcessor;
    :cond_2
    ...
    invoke-virtual {v0, v15, v4, v2, v3}, Lgov/nist/javax/sip/stack/MessageChannel;->sendMessage([BLjava/net/InetAddress;IZ)V
    :try_end_1
    ...
    invoke-interface {v2, v3, v9}, Lgov/nist/core/StackLogger;->logError(Ljava/lang/String;Ljava/lang/Exception;)V
